...
namespace MCPServerPlane.Tools
{
    [McpServerToolType]
    public class PlaneTools
    {
        ...
        public static async Task<string> CreateWorkItem(
            PlaneAPIService planeAPIService, [Description("The main title for the work item")] string name,
            [Description("The high level description for the work item")] string description,
            [Description("The status ID of the work item , derived from the GetAllWorkItemStatues tool")] string statusId)
        {
